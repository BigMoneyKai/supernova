...
static LRESULT CALLBACK win32_process_message(HWND hwnd, UINT msg, WPARAM w_param, LPARAM l_param) {
    event_context ctx = {};
    ...
    switch (msg) {
        ...
        case WM_SYSKEYDOWN:
            ...
            if (win32_state && win32_state->callbacks.on_key) {
                win32_state->callbacks.on_key(
                    (key_code)ctx.data.u16v[0], SN_TRUE, win32_state->callbacks.user_data
                );
            }
            break;
        ...
        case WM_SYSKEYUP:
            ...
            if (win32_state && win32_state->callbacks.on_key) {
                win32_state->callbacks.on_key(
                    (key_code)ctx.data.u16v[0], SN_FALSE, win32_state->callbacks.user_data
                );
            }
            break;

        case WM_LBUTTONDOWN:
            ctx.data.u16v[0] = MOUSE_CODE_1;
            event_fire(EVENT_CODE_BUTTON_PRESSED, NULL, ctx);
            if (win32_state && win32_state->callbacks.on_button) {
                win32_state->callbacks.on_button(
                    win32_button_to_mouse_code(1), SN_TRUE, win32_state->callbacks.user_data
                );
            }
            break;
        case WM_RBUTTONDOWN:
            ctx.data.u16v[0] = MOUSE_CODE_2;
            event_fire(EVENT_CODE_BUTTON_PRESSED, NULL, ctx);
            if (win32_state && win32_state->callbacks.on_button) {
                win32_state->callbacks.on_button(
                    win32_button_to_mouse_code(2), SN_TRUE, win32_state->callbacks.user_data
                );
            }
            break;
        case WM_MBUTTONDOWN:
            ctx.data.u16v[0] = MOUSE_CODE_3;
            event_fire(EVENT_CODE_BUTTON_PRESSED, NULL, ctx);
            if (win32_state && win32_state->callbacks.on_button) {
                win32_state->callbacks.on_button(
                    win32_button_to_mouse_code(3), SN_TRUE, win32_state->callbacks.user_data
                );
            }
            break;
        ...
        case WM_LBUTTONUP:
            ...
            if (win32_state && win32_state->callbacks.on_button) {
                win32_state->callbacks.on_button(
                    win32_button_to_mouse_code(1), SN_FALSE, win32_state->callbacks.user_data
                );
            }
            break;
        case WM_RBUTTONUP:
            ...
            if (win32_state && win32_state->callbacks.on_button) {
                win32_state->callbacks.on_button(
                    win32_button_to_mouse_code(2), SN_FALSE, win32_state->callbacks.user_data
                );
            }
            break;
        case WM_MBUTTONUP:
            ...
            if (win32_state && win32_state->callbacks.on_button) {
                win32_state->callbacks.on_button(
                    win32_button_to_mouse_code(3), SN_FALSE, win32_state->callbacks.user_data
                );
            }
            break;
        ...
        case WM_MOUSEMOVE:
            ...
            if (win32_state && win32_state->callbacks.on_mouse) {
                win32_state->callbacks.on_mouse(
                    ctx.data.i16v[0], ctx.data.i16v[1], win32_state->callbacks.user_data
                );
            }
            break;
        ...
        case WM_SIZE: {
            ...
            if (win32_state && win32_state->callbacks.on_resize) {
                win32_state->callbacks.on_resize(
                    ctx.data.u16v[0], ctx.data.u16v[1], win32_state->callbacks.user_data
                );
            }
        } break;
